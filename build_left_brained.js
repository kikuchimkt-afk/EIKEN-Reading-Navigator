...
// Build the complete data directly without external JSON files
const leftBrainedData = {
...
const jsonPath = path.resolve(__dirname, 'left_brained_complete.json');
fs.writeFileSync(jsonPath, JSON.stringify(leftBrainedData, null, 4), 'utf8');
console.log(`Created: ${jsonPath}`);
console.log('This is paragraph 1 only. Full data will be built next.');
